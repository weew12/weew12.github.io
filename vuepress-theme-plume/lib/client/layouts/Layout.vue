...
import VPBulletin from '../components/VPBulletin.vue'
...
import {useCloseSidebarOnEscape, useData, useEncrypt, useSidebar} from '../composables'
...
<template>
  <div v-if="frontmatter.pageLayout !== false && frontmatter.pageLayout !== 'custom'" class="theme-plume vp-layout"
       :class="frontmatter.pageClass" vp-container>
