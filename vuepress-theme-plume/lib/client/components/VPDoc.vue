...
import VPComment from './VPComment.vue'
import VPDocAside from './VPDocAside.vue'
import VPDocBreadcrumbs from './VPDocBreadcrumbs.vue'
import VPDocCopyright from './VPDocCopyright.vue'
...
[data-theme=dark] .vp-doc-container {
  --vp-doc-blog-bg: rgba(30, 120, 120, .15)
}
