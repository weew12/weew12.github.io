---
title: （三）：深入TSDB - 读懂Prometheus的存储底层
createTime: 2026/03/28 19:28:07
permalink: /other/prometheus/prometheus_techniques/tdtih66f/
---
## 导语
...
**图3-2 bstream.writeByte()方法工作原理**

![bstream.writeByte跨字节场景](./pics/16.jpg)

**图3-3 bstream.writeByte()跨字节场景（补充）**

![bstream.readByte原理1](./pics/17.jpg)

**图3-4 bstream.readByte()方法工作原理1**
...
**图3-11 跨page的超长Record写入状态**

![单page多Record写入场景](./pics/33.jpg)

**图3-12 单page多Record写入场景**
...
**图3-15 Prometheus TSDB block目录结构**
