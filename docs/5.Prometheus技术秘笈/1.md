...
tags:
  ...
  - Prometheus
---
# Prometheus 技术秘笈（一）：入门篇 - 时序数据库对比与Prometheus架构解析
...
![TICK Stack架构](./pics/1.jpg)

**图 1-2：TICK Stack 架构图**
...
**图1-8：Prometheus自身metrics数据格式示例**
...
**图 1-11：Goland 配置Prometheus运行参数**
...
**图 1-12：Grafana Data Sources 页面**
...
**图 1-13：Grafana 配置Prometheus数据源**
...
**图 1-14：Grafana Dashboard 入口**

1. 选择“New panel” → “Add Query”；

![Grafana新建Panel](./pics/12.jpg)

**图 1-15：Grafana 新建Panel并添加Query**

1. 选择已配置的Prometheus数据源，输入PromQL语句（如`go_goroutines`），即可可视化时序数据；

![Grafana可视化Prometheus数据](./pics/13.jpg)

**图 1-16：Grafana 可视化Prometheus时序数据**
